...
Setimo se da u algoritmu propagacije unazad računamo izvode funkcije gibotaka u odnosu na matrice težina $W_1$, $W_2$ i $W_3$ i pomoću izračunatih vrednosti ažuriramo vrednosti matrica $W_1$, $W_2$ i $W_3$. Može se pokazati da važi (napomena: sa $@$ je označeno matrično množenje, a sa $\cdot$ koordinatno množenje):
